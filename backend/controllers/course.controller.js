...
export const buyCourses = async (req, res) => {
    ...
    // These should come from frontend — ensure your frontend sends them!
    ...
    try {
        ...
        const amount = course.price * 100; // Convert to paise (INR)
        ...
        const paymentIntent = await stripe.paymentIntents.create({
            ...
            metadata: {
                export_transaction: `Purchase of course: ${course.title} by user ${userId}`,
                courseId,
                userId,
            },
            shipping: {
                ...
                address: {
                    ...
                    country: customerAddress.country, // Must be 2-letter ISO code (e.g. "IN", "US")
                },
            },
        });
